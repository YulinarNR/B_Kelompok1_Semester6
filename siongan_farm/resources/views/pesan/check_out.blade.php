    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <tr >
                        ...
                        <td class="text-center">
                            <!-- diarahkan ke alamat aja dlu -->
                            <a href="{{ url('keranjangcheckout')}}" class="btn btn-success" >
                ...
                <!-- Lanjutkan belanja -->
                <a href="{{ url('home#shop-area')}}" class="btn btn-warning text-white">Lanjutkan Belanja</a>
                    </div>
                </div>
            </div>
        </div>
